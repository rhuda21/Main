...
local SkillTree = require(game:GetService("ReplicatedStorage").Shared.Registry.SkillTreeLayouts)
local HttpService = game:GetService("HttpService")
local layouts = SkillTree.LAYOUTS
local JSON = HttpService:JSONEncode(layouts)
